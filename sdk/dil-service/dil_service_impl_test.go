...
func TestNewDilService(t *testing.T) {
	testName := "Test new dil service"

	t.Run(testName, func(t *testing.T) {
		// set service
		service := NewDilService(urlMock)

		assert.NotNil(t, service)
	})
}

func TestDilServiceImplGetDataUnitByCode(t *testing.T) {
	httpmock.Activate()
